...
def gen_AFM_bonds_random(d, p, seed) -> NDArray[np.int_]:
    """
    Generate random bond configuration, corresponding to qubit error.
...
def main():
    ...
    # run simulation
    z_check_matrix = get_z_check_matrix(args.d)
    AFM_bonds = gen_AFM_bonds_random(args.d, args.p, args.seed)
