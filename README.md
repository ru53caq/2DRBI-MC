...
- **Temperature Distribution:**  
  - For the MC method, $T_{Top}$ should be slightly above $T_{\text{Nishimori}}$ , typically $T_{Top} \approx 1.1$. Ensure it doesn’t cross the phase transition.  
  - For the PT method, $T_{Top_{PT}}$ must be in the disordered phase. A good starting point is $T_{Top_{PT}} \geq 2.5$.

- **Sanity Checks:**  
  1. Ensure line updates at $T_{Top_{PT}}$ are accepted frequently.
